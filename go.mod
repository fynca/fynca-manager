module github.com/ehazlett/fynca-manager

go 1.17

replace git.underland.io/ehazlett/fynca => ../fynca

require (
	git.underland.io/ehazlett/fynca v0.0.0-00010101000000-000000000000
